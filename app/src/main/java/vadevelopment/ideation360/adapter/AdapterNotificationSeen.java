...
public class AdapterNotificationSeen extends RecyclerView.Adapter<AdapterNotificationSeen.ViewHolder> {

    private Context context;
    private ArrayList<NotificationSeen_Skeleton> arraylist;
    private HomeActivity homeActivity;

    public AdapterNotificationSeen(Context context, ArrayList<NotificationSeen_Skeleton> arraylist) {
    ...
    @Override
    public AdapterNotificationSeen.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.rownotif_new, parent, false);
        AdapterNotificationSeen.ViewHolder viewHolder = new AdapterNotificationSeen.ViewHolder(itemLayoutView);
        return viewHolder;
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(final AdapterNotificationSeen.ViewHolder viewHolder, final int position) {
